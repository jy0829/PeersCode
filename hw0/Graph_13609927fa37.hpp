...
class Graph {
 ...
 public:
  ...
  class Node {
   public:
    ...
    bool operator==(const Node& n) const {
      // HW0: YOUR CODE HERE
      return ( (graph_ == n.graph_) && (index() == n.uid_) );
    }
  ...
  Edge edge(size_type i) const {
    // HW0: YOUR CODE HERE
    std::pair<size_type, size_type> e = this->edges_[i];
    return Edge(this, std::get<0>(e), std::get<1>(e));
  }
  ...
  bool has_edge(const Node& a, const Node& b) const {
    ...
    for(size_type i = 0; i < edges_.size(); i++) {
        std::pair<size_type, size_type> e = edges_[i];
        size_type n1_uid = std::get<0>(e);
        size_type n2_uid = std::get<1>(e);
        if ( ( std::min(n1_uid, n2_uid) == std::min(a.uid_, b.uid_) ) &&
             ( std::max(n1_uid, n2_uid) == std::max(a.uid_, b.uid_) ) ) {
           return true;
        }
    }
    return false;
  ...
  Edge add_edge(const Node& a, const Node& b) {
    ...
    if (has_edge(a, b)) {
        ...
        std::pair<size_type, size_type> e (a.uid_, b.uid_);
 ...
 private:
  ...
  /** Vector of points to store nodes */
  std::vector<Point> nodes_;

  /** Vector of pairs to store edges */
