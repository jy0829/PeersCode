...
class Graph {
 ...
 public:
  ...
  Graph() 
      : nodes_(), edges_(), node_size_(0), edge_size_(0)
  {
    // HW0: YOUR CODE HERE
  }
  ...
  class Edge {
   ...
   private:
    ...
    /** Helper method to return the pair of Nodes associated to the edge.
     * This fetches the element with the correct uid in the list of nodes,
     * and retrieve the Point associated.
     */
    std::pair <Node, Node>& fetch() const {
  ...
  bool has_edge(const Node& a, const Node& b) const {
    ...
    return (std::find(edges_.begin(), edges_.end(), std::make_pair(a, b)) != edges_.end()) ||
           (std::find(edges_.begin(), edges_.end(), std::make_pair(b, a)) != edges_.end());
  }
  ...
  Edge add_edge(const Node& a, const Node& b) {
    // HW0: YOUR CODE HERE
    auto it1 = std::find(edges_.begin(), edges_.end(), std::make_pair(a, b));
    auto it2 = std::find(edges_.begin(), edges_.end(), std::make_pair(b, a));
    size_t edge_id;
    if (it1 != edges_.end()) {
      edge_id = std::distance(edges_.begin(), it1);
      return Edge(this, edge_id);
    }
    else if (it2 != edges_.end()) {
      edge_id = std::distance(edges_.begin(), it2);
      return Edge(this, edge_id);
    }
    else {
      edges_.push_back(std::make_pair(a, b));
      return Edge(this, edge_size_++);
    }
  }
 ...
 private:
  ...
  // edges_ contains the pairs of nodes ids corresponding to every edge
